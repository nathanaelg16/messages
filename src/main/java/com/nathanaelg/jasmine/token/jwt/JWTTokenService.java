package com.nathanaelg.jasmine.token.jwt;

import com.google.common.base.Supplier;
import com.google.common.collect.ImmutableMap;
import com.nathanaelg.jasmine.date.service.DateService;
...
public class JWTTokenService implements Clock, TokenService {
    ...
    JWTTokenService(final DateService dates, @Value("${jwt.issuer:nathanaelg}") final String issuer,
                    @Value("${jwt.expiration-sec:28800}") final int expirationSec,
                    @Value("${jwt.clock-skew-sec:5}") final int clockSkewSec,
                    @Value("${jwt.secret:ZGOUNjYx0iTNNlG}") final String secret) {
        super();
